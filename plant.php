                                                    ...
                                                    <form role="form" id="plantForm" class="needs-validation" novalidate autocomplete="off">
                                                                    ...
                                                                    <div class="card-body">
                                                                        <div class="row">
                                                                            <div class="col-xxl-12 col-lg-12 mb-3">
                                                                                <div class="row">
                                                                                    <label for="plantCode" class="col-sm-4 col-form-label"><?=$languageArray['plant_code_code'][$language]?></label>
                                                                                    <div class="col-sm-8">
                                                                                        <input type="text" class="form-control" id="plantCode" name="plantCode" placeholder="<?=$languageArray['plant_code_code'][$language]?>" required>
                                                                            ...
                                                                            <div class="col-xxl-12 col-lg-12 mb-3">
                                                                                <div class="row">
                                                                                    <label for="plantName" class="col-sm-4 col-form-label"><?=$languageArray['plant_name_code'][$language]?></label>
                                                                                    <div class="col-sm-8">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="hstack gap-2 justify-content-end">
                                                                ...
                                                                <button type="button" class="btn btn-success" id="submitPlant"><?=$languageArray['submit_code'][$language]?></button>
                                                            </div>
                                                        </div><!--end col-->                                                               
                                                    </form>
                                                </div>
                                            ...
                                            <div class="modal-content">
                                                <form role="form" id="uploadForm">
                                                    ...
                                                    <div class="modal-footer justify-content-between bg-gray-dark color-palette">
                                                        ...
                                                        <button type="button" class="btn btn-success" id="uploadPlant"><?=$languageArray['submit_code'][$language]?></button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
                                                        ...
                                                        <table id="plantTable" class="table table-bordered nowrap table-striped align-middle" style="width:100%">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th><?=$languageArray['plant_code_code'][$language]?></th>
