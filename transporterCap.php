                                                                    ...
                                                                    <div class="card-body">
                                                                        <div class="row">
                                                                            <div class="col-xxl-12 col-lg-12 mb-3">
                                                                                <div class="row">
                                                                                    <label for="transportFit" class="col-sm-4 col-form-label">Transport Fit</label>
                                                                                    <div class="col-sm-8">
                                                                                        <input type="text" class="form-control" id="transportFit" name="transportFit" placeholder="Transport Fit" required>
                                                                            ...
                                                                            <div class="col-xxl-12 col-lg-12 mb-3">
                                                                                <div class="row">
                                                                                    <label for="transportLoad" class="col-sm-4 col-form-label">Transport Load</label>
                                                                                    <div class="col-sm-8">
                                                                                        <input type="text" class="form-control" id="transportLoad" name="transportLoad" placeholder="Transport Load" required>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="card">
                                                    ...
                                                    <div class="card-body">
                                                        <table id="transporterCapTable" class="table table-bordered nowrap table-striped align-middle" style="width:100%">
                                                            <thead>
                                                                <tr>
...
$(function () {
    $('#selectAllCheckbox').on('change', function() {
        var checkboxes = $('#transporterCapTable tbody input[type="checkbox"]');
        checkboxes.prop('checked', $(this).prop('checked')).trigger('change');
    });

    table = $("#transporterCapTable").DataTable({
        "responsive": true,
        "autoWidth": false,
        'processing': true,
        'serverSide': true,
        'serverMethod': 'post',
        'ajax': {
            'url':'php/loadTransporterCap.php'
        },
        'columns': [
            {
    ...
    $('#submitTransporter').on('click', function(){
        if($('#transporterForm').valid()){
            $('#spinnerLoading').show();
            $.post('php/transporterCap.php', $('#transporterForm').serialize(), function(data){
    ...
    $('#addTransporterCap').on('click', function(){
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (obj.status === 'success') {
                    ...
                    $("#successBtn").attr('data-toast-text', obj.message);
                    $("#successBtn").click();
                    $('#transporterCapTable').DataTable().ajax.reload(null, false);
                } 
                else if (obj.status === 'failed') {
                    $('#spinnerLoading').hide();
                    $("#failBtn").attr('data-toast-text', obj.message );
    ...
    $('#multiDeactivate').on('click', function () {
        ...
        $("#transporterCapTable tbody input[type='checkbox']").each(function () {
            if (this.checked) {
...
function edit(id){
    $('#spinnerLoading').show();
    $.post('php/getTransporterCap.php', {userID: id}, function(data)
    {
        var obj = JSON.parse(data);
        if(obj.status === 'success'){
