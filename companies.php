                                        ...
                                        <div class="modal-dialog modal-dialog-scrollable modal-lg">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalScrollableTitle">Add New Company</h5>
...
$(function () {
    ...
    $('#submitPlant').on('click', function(){
        if($('#plantForm').valid()){
            $('#spinnerLoading').show();
            $.post('php/company.php', $('#plantForm').serialize(), function(data){
...
function edit(id){
    ...
    $.post('php/getCompany.php', {userID: id}, function(data)
    {
        ...
        if(obj.status === 'success'){
            ...
            $('#addModal').find('#companyCode').val(obj.message.plant_code);
...
function reactivate(id) {
  if (confirm('Do you want to reactivate this item?')) {
    $('#spinnerLoading').show();
    $.post('php/reactivateMasterData.php', {userID: id, type: "Company"}, function(data){
        var obj = JSON.parse(data);
