...
<head>
    <title>Driver | SPMT - Weighing System</title>
                                                    ...
                                                    <form role="form" id="driverForm" class="needs-validation" novalidate autocomplete="off">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="hstack gap-2 justify-content-end">
                                                                ...
                                                                <button type="button" class="btn btn-success" id="submitDriver"><?=$languageArray['submit_code'][$language]?></button>
                                                            </div>
                                                        </div><!--end col-->                                                               
                                                    </form>
                                                </div>
...
function reactivate(id) {
  if (confirm('Do you want to reactivate this item?')) {
    $('#spinnerLoading').show();
    $.post('php/reactivateMasterData.php', {userID: id, type: "Driver"}, function(data){
        var obj = JSON.parse(data);
