                                        ...
                                        <div class="modal-dialog modal-dialog-scrollable modal-lg">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalScrollableTitle">Add New Location</h5>
                                                    ...
                                                    <form role="form" id="locationForm" class="needs-validation" novalidate autocomplete="off">
                                                                    ...
                                                                    <div class="card-body">
                                                                        <div class="row">
                                                                            <div class="col-xxl-12 col-lg-12 mb-3">
                                                                                <div class="row">
                                                                                    <label for="locationCode" class="col-sm-4 col-form-label">Location Code *</label>
                                                                                    <div class="col-sm-8">
                                                                            ...
                                                                            <div class="col-xxl-12 col-lg-12 mb-3">
                                                                                <div class="row">
                                                                                    <label for="indicator" class="col-sm-4 col-form-label">Indicator</label>
                                                                                    <div class="col-sm-8">
                                                                                        <select class="form-control" style="width: 100%;" id="indicator" name="indicator">
                                                                                            <option value="BDI">BDI2001B</option>
                                                                                            <option value="X2S">SYNCTRONIX X2S</option>
                                                                                            <option value="X722">SYNCTRONIX X722</option>
                                                                                            <option value="EX2001">SYNCTRONIX EX2001</option>
                                                                                            <option value="D2008">SYNCTRONIX D2008</option>
                                                                                        </select>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-xxl-12 col-lg-12 mb-3">
                                                                                <div class="row">
                                                                                    <label for="serialPort" class="col-sm-4 col-form-label">Serial Port</label>
                                                                                    <div class="col-sm-8">
                                                                            ...
                                                                            <div class="col-xxl-12 col-lg-12 mb-3">
                                                                                <div class="row">
                                                                                    <label for="serialPortBaudRate" class="col-sm-4 col-form-label">Baud Rate</label>
                                                                                    <div class="col-sm-8">
                                                                            ...
                                                                            <div class="col-xxl-12 col-lg-12 mb-3">
                                                                                <div class="row">
                                                                                    <label for="serialPortDataBits" class="col-sm-4 col-form-label">Data Bits</label>
                                                                                    <div class="col-sm-8">
                                                                            ...
                                                                            <div class="col-xxl-12 col-lg-12 mb-3">
                                                                                <div class="row">
                                                                                    <label for="serialPortParity" class="col-sm-4 col-form-label">Parity</label>
                                                                                    <div class="col-sm-8">
                                                                            ...
                                                                            <div class="col-xxl-12 col-lg-12 mb-3">
                                                                                <div class="row">
                                                                                    <label for="serialPortStopBits" class="col-sm-4 col-form-label">Stop bits</label>
                                                                                    <div class="col-sm-8">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="hstack gap-2 justify-content-end">
                                                                ...
                                                                <button type="button" class="btn btn-success" id="submitLocation">Submit</button>
                                                            </div>
                                                        </div><!--end col-->                                                               
                                                    </form>
                                                </div>
                                            ...
                                            <div class="modal-content">
                                                <form role="form" id="uploadForm">
                                                    ...
                                                    <div class="modal-footer justify-content-between bg-gray-dark color-palette">
                                                        ...
                                                        <button type="button" class="btn btn-success" id="uploadLocation">Save changes</button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
...
$(function () {
    ...
    $('#submitLocation').on('click', function(){
        if($('#locationForm').valid()){
            $('#spinnerLoading').show();
            $.post('php/locations.php', $('#locationForm').serialize(), function(data){
    ...
    $('#addLocation').on('click', function(){
        ...
        $('#addModal').find('#serialPort').val("");
        $('#addModal').find('#serialPortBaudRate').val("");
        $('#addModal').find('#serialPortDataBits').val("");
        $('#addModal').find('#serialPortParity').val("");
        $('#addModal').find('#serialPortStopBits').val("");
    ...
    $('#multiDeactivate').on('click', function () {
        ...
        if (selectedIds.length > 0) {
            if (confirm('Are you sure you want to cancel these items?')) {
                $.post('php/deleteLocation.php', {userID: selectedIds, type: 'MULTI'}, function(data){
                    var obj = JSON.parse(data);
...
function edit(id){
    ...
    $.post('php/getLocation.php', {userID: id}, function(data)
    {
        ...
        if(obj.status === 'success'){
            ...
            $('#addModal').find('#serialPort').val(obj.message.com_port);
            $('#addModal').find('#serialPortBaudRate').val(obj.message.bits_per_second);
            $('#addModal').find('#serialPortDataBits').val(obj.message.data_bits);
            $('#addModal').find('#serialPortParity').val(obj.message.parity);
            $('#addModal').find('#serialPortStopBits').val(obj.message.stop_bits);
...
function reactivate(id) {
  if (confirm('Do you want to reactivate this item?')) {
    $('#spinnerLoading').show();
    $.post('php/reactivateMasterData.php', {userID: id, type: "Location"}, function(data){
        var obj = JSON.parse(data);
