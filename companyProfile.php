                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="text" class="form-control input-readonly" id="companyRegNo" name="companyRegNo" placeholder="<?=$languageArray['company_reg_no_code'][$language]?>" value="<?=$usercompany_reg_no ?>" required <?= $readonly ?>>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="text" class="form-control input-readonly" id="companyName" name="companyName" placeholder="<?=$languageArray['company_name_code'][$language]?>" value="<?=$username ?>" required <?= $readonly ?>>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-12">
