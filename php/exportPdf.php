                            ...
                            <body>
                                <table style="width:100%;">
                                    ...
                                    foreach ($groupedData as $product => $rows) {
                                        ...
                                        $message .= '<tr>
                                            <th style="font-size: 10px;" colspan="'.($includeContainer == 'Y' || $includeDifferentBin == 'Y' ? '18' : '14').'">Subtotal (' . $product . ')</th>
                                    ...
                                    $message .= '</tbody>
                                        <tfoot>
                                            <tr>
                                                <th style="font-size: 10px;" colspan="'.($includeContainer == 'Y' || $includeDifferentBin == 'Y' ? '18' : '14').'">Grand Total</th>
