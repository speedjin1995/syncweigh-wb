...
## Fetch records
$empQuery = "select Users.id, Users.employee_code, Users.username, Users.useremail, Users.name, roles.role_name, Users.plant_id, Users.basic_salary, Users.nric, Users.status from Users, roles WHERE 
...
if ($_SESSION["roles"] != 'ADMIN' && $_SESSION["roles"] != 'SADMIN' && $_SESSION["roles"] != 'AUTHORITY') {
  ...
  if (!empty($plantIds) && is_array($plantIds)) {
      ...
      $empQuery = "SELECT Users.name AS empname, Users.id, Users.employee_code, Users.username, Users.useremail, Users.name, 
                          roles.role_name, Users.plant_id, Users.basic_salary, Users.nric,  Users.status
                   FROM Users 
...
elseif ($_SESSION["roles"] == 'AUTHORITY') {
  $empQuery = "SELECT Users.id, Users.employee_code, Users.username, Users.useremail, Users.name, Users.nric, roles.role_name, Users.plant_id, Users.basic_salary, Users.status
               FROM Users
               JOIN roles ON Users.role = roles.role_code
               WHERE Users.status IN (0)
               AND Users.role <> 'SADMIN'
