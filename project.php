                                            ...
                                            <div class="modal-content">
                                                <form role="form" id="uploadForm">
                                                    ...
                                                    <div class="modal-footer justify-content-between bg-gray-dark color-palette">
                                                        ...
                                                        <button type="button" class="btn btn-success" id="uploadSite">Save changes</button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
...
$(function () {
    ...
    $('#submitSite').on('click', function(){
        if($('#siteForm').valid()){
            $('#spinnerLoading').show();
            $.post('php/projects.php', $('#siteForm').serialize(), function(data){
    ...
    $('#multiDeactivate').on('click', function () {
        ...
        if (selectedIds.length > 0) {
            if (confirm('Are you sure you want to cancel these items?')) {
                $.post('php/deleteProject.php', {userID: selectedIds, type: 'MULTI'}, function(data){
                    var obj = JSON.parse(data);
...
function edit(id){
    $('#spinnerLoading').show();
    $.post('php/getProject.php', {userID: id}, function(data)
    {
        var obj = JSON.parse(data);
        if(obj.status === 'success'){
...
function deactivate(id){
    ...
    if (confirm('Are you sure you want to cancel this item?')) {
        $.post('php/deleteProject.php', {userID: id}, function(data){
            var obj = JSON.parse(data);
...
function reactivate(id) {
  if (confirm('Do you want to reactivate this item?')) {
    $('#spinnerLoading').show();
    $.post('php/reactivateMasterData.php', {userID: id, type: "Project"}, function(data){
        var obj = JSON.parse(data);
